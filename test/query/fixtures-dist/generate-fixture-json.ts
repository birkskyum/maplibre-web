...
import localizeURLs from '../../integration/lib/localize-urls';
 ...
 */
export function generateFixtureJson(rootDirectory, suiteDirectory, outputDirectory = 'test/query/fixtures-dist', includeImages = false) {
